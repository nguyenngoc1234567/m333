...
<div class="overlay">
    <form action="{{ route('handdle-login') }}" method="post">
        ...
        @enderror
            ...
            <div class="other">
                 <button class="btn submits frgt-pass" ><a href="{{ route('shop.register') }}">Đăng kí tài khoản</a></button>
                <button class="btn submits frgt-pass" ><a href="{{ route('view.quenmatkhau') }}">Quên mật khẩu</a> </button>
            </div>
